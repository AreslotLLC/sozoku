...
export const metadata: Metadata = {
    title: "免責事項 | あなたの街の相続相談ナビ",
    description: "あなたの街の相続相談ナビの免責事項です。当サイトの情報利用に関する注意事項、アフィリエイト広告の使用について説明しています。",
    alternates: {
        canonical: FULL_URL,
    },
    robots: {
                        ...
                        <div className="prose prose-slate dark:prose-invert max-w-none space-y-10">
                            ...
                            <section>
                                ...
                                <p className="text-slate-600 dark:text-slate-400 leading-relaxed mb-4">
                                    あなたの街の相続相談ナビ（以下「当サイト」といいます）では、掲載する情報について、作成時点において可能な限り正確であるよう努めております。しかしながら、当サイトが提供するコンテンツの内容について、その正確性、完全性、最新性、妥当性、および特定の目的への適合性を保証するものではありません。
                                </p>
                                <div className="p-4 sm:p-5 bg-amber-50 dark:bg-amber-950/30 border border-amber-200 dark:border-amber-900 rounded-xl">
                                    <p className="text-sm sm:text-base text-slate-700 dark:text-slate-300 leading-relaxed">
                                        <strong>ご注意：</strong>当サイトの掲載情報は、時間の経過による変化や、税制改正等によって内容が異なる場合があります。実際のアクションにあたっては、必ず各税理士や専門家へ直接ご確認いただき、最新かつ正確な情報を取得してください。
                                    </p>
                                </div>
                            </section>
                            ...
                            <section>
                                ...
                                <p className="text-slate-600 dark:text-slate-400 leading-relaxed">
                                    情報のご利用は、訪問者ご自身の判断と責任において行っていただきますようお願いいたします。特に相続税申告、遺産分割協議、不動産相続など多額の費用が発生するサービスに関しては、必ず有資格者や専門家への相談を強くお勧めいたします。
                                </p>
                            </section>
