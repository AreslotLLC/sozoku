                ...
                <div className="max-w-6xl mx-auto">
                    ...
                    <div className="flex flex-col lg:flex-row items-center gap-6 lg:gap-12">
                        ...
                        <div className="flex-1 w-full max-w-md lg:max-w-none flex justify-end">
                            <div className="relative w-full aspect-[21/9] lg:aspect-[16/7] max-w-[560px] rounded-3xl overflow-hidden shadow-xl shadow-primary/10 ring-4 ring-white/50 backdrop-blur-sm">
                                <img
                                    src={heroImage}
                                    alt={categoryName}
